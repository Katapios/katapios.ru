...
public function __construct() {		
		...
		$this->conf = array(
			'start_day' => 'monday',
		//	'show_next_prev' => true,
		//	'next_prev_url' => base_url().'pages/show_stat/about'
	...
	$this->conf['template'] = '
                        ...
                        <div class="events">
							<ul>								
								<li>
                                    ...
                                    <a style="margin:0;padding:0;" href="/pages/news">следите за новостями</a>
								</li>
							</ul>
						</div>
            ...
            <div class="date_has_event"><div class="today">{day}</div>
                        ...
                        <div class="events">
							<ul>								
								<li>
									<p style="margin:0;padding:0;">{content}</p>
                                    <p style="margin:0;padding:0;">сегодня!</p>
								</li>
							</ul>
						</div>
